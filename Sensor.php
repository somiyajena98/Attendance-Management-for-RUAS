...
$qry=mysqli_query($conn,"select count(motion_count), count(biometric_count) from student_attendance 
WHERE course_id="."'".$course_id."'"." AND section_id="."'".$section_id."'"." AND date=curdate()")
